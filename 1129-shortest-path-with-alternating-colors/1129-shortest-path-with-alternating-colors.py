class Solution:
    def shortestAlternatingPaths(self, num_nodes, red_edges, blue_edges):
        # Create a graph with 2 lists for each node, representing red and blue edges
        ...
        # Return the minimum distance between node 0 and all other nodes, or -1 if not possible
